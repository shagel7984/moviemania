...
/**
 * Class MyConfigEntityDeleteForm.
 *
 * Provides a confirm form for deleting the entity. This is different from the
 * add and edit forms as it does not inherit from MyConfigEntityFormBase. The reason for
 ...
 */
class MyConfigEntityDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete myconfigentity %label?', [
  ...
  public function getConfirmText() {
    return $this->t('Delete My Config Entity');
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.myconfigentity.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    drupal_set_message($this->t('My Config Entity %label was deleted.', [
      '%label' => $this->entity->label(),
    ]));
