 ...
 * 'hello_world.changecontentevent'. This event will be dispatched by the
...
final class CustomEvents {
   ...
   * \Drupal\hello_world\Event\IncidentReportEvent instance.
   *
   * @Event
   *
   * @see \Drupal\hello_world\Event\ReportCustomEvent
   *
   * @var string
   */
  const CHANGECONTENT = 'hello_world.changecontentevent';
