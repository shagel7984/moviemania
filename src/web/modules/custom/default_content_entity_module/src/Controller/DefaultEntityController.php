...
namespace Drupal\default_content_entity_module\Controller;
...
class DefaultEntityController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\default_content_entity_module\Entity\DefaultEntityInterface $default_entity
  ...
  public function revisionOverview(DefaultEntityInterface $default_entity) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\default_content_entity_module\DefaultEntityInterface $revision */
