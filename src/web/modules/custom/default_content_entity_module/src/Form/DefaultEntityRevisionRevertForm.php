...
namespace Drupal\default_content_entity_module\Form;
...
class DefaultEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\default_content_entity_module\Entity\DefaultEntityInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\default_content_entity_module\Entity\DefaultEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\default_content_entity_module\Entity\DefaultEntityInterface
